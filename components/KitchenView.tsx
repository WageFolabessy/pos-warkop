      ...
      {batchItemSummary.length > 0 && (
        <div className="bg-gray-50 border-b border-gray-200 px-3 sm:px-6 py-2 shrink-0 overflow-x-auto">
          <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs">
            <span className="text-[11px] text-gray-500 uppercase tracking-wider font-medium shrink-0 mr-1">
              Antrean Item:
            </span>
              ...
              {filteredOrders.map((order) => {
                ...
                return (
                  ...
                  >
                    {/* Ticket Header */}
                    <div
                      className={`p-3.5 border-b flex items-start justify-between gap-2 transition-colors ${
                        currentStatus === 'siap_saji'
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <span className="text-[11px] font-mono flex items-center gap-1 mt-0.5 text-gray-500">
                      ...
                      {/* Status Badge — high contrast & crisp */}
                      <span
                        className={`text-[10px] font-medium uppercase tracking-wider px-2.5 py-0.5 rounded-full border transition-colors ${
                          currentStatus === 'siap_saji'
                            ? 'bg-gray-900 text-white border-gray-900 font-semibold'
                            : currentStatus === 'dimasak'
                      ...
                      >
                        {currentStatus === 'siap_saji'
                          ? 'Siap Saji'
                          : currentStatus === 'dimasak'
                          ? (completedIds.length > 0 ? `${completedIds.length}/${order.items.length} Siap` : 'Diracik')
                          : 'Menunggu'}
                      </span>
                    </div>
